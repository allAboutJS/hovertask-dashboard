  ...
  return (
    <div className="bg-white shadow p-4 space-y-12 min-h-full">
      ...
      <div className="p-6 shadow bg-white rounded-3xl space-y-3 text-center">
        ...
        <p className="text-sm">
          You need to link your Facebook account to website before you can start earning with your social media account.
          Click the button below to link your account now.
        </p>
        <Link
